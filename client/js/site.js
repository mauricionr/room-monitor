(function () {
	...
	function initializeWatching() {
		...
		var considerTime = 500;		// time window to consider best capture, in ms
		var chillTime = 1500;			// time to chill after committing, in ms
		var historyMax = 20;				// max number of past captures to show on page
